...
@brief defines variables and methods for the middleEarth destinations
...
void MiddleEarth::print() {
  ...
  /*@brief prints out the information for the created \p world */
...
float MiddleEarth::getDistance(const string& city1, const string& city2) {
  ...
  /* this function returns the \c distance between the two cities that were passed in
     as parameters
  */
...
vector<string> MiddleEarth::getItinerary(unsigned int length) {
    ...
    /*
      @return The updated <b>itinerary</b> 
    */
